    ...
    <form id="myForm" runat="server">
        ...
        <div class="container">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true" AutoGenerateSelectButton="false" AllowPaging="false">
                <Columns>
                    <asp:BoundField ItemStyle-Width="150px" DataField="Name" HeaderText="Restaurant" />
                    <asp:BoundField ItemStyle-Width="150px" DataField="TimeOfReserv" HeaderText="Reservation Time" />
                </Columns>
            </asp:GridView>
