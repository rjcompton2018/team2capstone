							  ...
							  <div class="container-fluid">
								...
								<div class="row">
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton1" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>
												<p></p>
										</div>
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton2" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>
												<p></p>
										</div>
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton3" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>											  
												<p></p>
								        </div>
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton4" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div> 
												<p></p>
										</div>
								...
								<div class="row">
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton5" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div> 
												<p></p>
										</div>
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton6" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>
												<p></p>
										</div>
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton7" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>
												<p></p>
										</div>
										<div class="col">
                                                ...
                                                <asp:RadioButton ID="RadioButton8" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>
												<p></p>
										</div>
								...
								<div class="row">
										<div class="col">
                                            ...
                                            <asp:RadioButton ID="RadioButton9" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div> 
												<p></p>
										</div>
										<div class="col">
                                            ...
                                            <asp:RadioButton ID="RadioButton10" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div>
												<p></p>
										</div>
										<div class="col">
                                            ...
                                            <asp:RadioButton ID="RadioButton11" Text="" runat="server" />	<p></p>
												<p></p>
												<div class="div1"></div> 
												<p></p>
								        </div>
										<div class="col">
                                            ...
                                            <asp:RadioButton ID="RadioButton12" Text="" runat="server" />	<p></p>
