<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="restaurantConfiguration.aspx.cs" Inherits="WebApplication1.restaurantConfiguration" %>
...
<body>
	...
	<div class="container" style="margin-top:30px">
			...
			<form runat="server" action="/action_page.php">
			...
			<!-- Restaurant configuration options -->
			  ...
			  Description:<p></p>
			  <p></p>
			  <textarea id="description" runat="server" name="message" maxlength="100" rows="10" cols="40"> </textarea>
