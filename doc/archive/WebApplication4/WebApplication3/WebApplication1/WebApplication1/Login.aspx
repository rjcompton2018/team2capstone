  ...
  <div class="row">
    <div class="col-sm-8">
	  ...
	  <div class="menu">
		...
		<p> <a href="restaurantSignUpPage">Click here to sign up!</a></p> 
		 <!--The form asks for a user's email and password-->
		<p> Login to your account: </p>
			<form id="form" method="POST" runat="server">
			<p>Email:</p><input id="txtEmail" runat="server" type="email" name="email" required text="text">
			</br>
			</br>
			<p>Password:</p><input runat="server" id="txtPassword" type="password" name="password" required text="text">
                      <asp:Button runat="server" Text="Sign Up" OnClick="btnSubmit_OnClick" id="btnSubmit" CssClass="signupbtn"></asp:Button>
		</form>
		</br>
		</br>
		</div>
